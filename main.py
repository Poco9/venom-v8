...
AUTHORIZED_USERS = [2102111052,6376282471]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @empire_devil9")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @empire_devil9\n"
...
def show_id(message):
    ...
    bot_owner = "empire_devil9"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @empire_devil9")
...
This bot is owned and operated by @empire_devil9 on Telegram and lokesh_yt9 on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🚫 LIMITATION OF LIABILITY**: The owner and operator of this bot, @empire_devil9 on Telegram and lokesh_yt9 on Instagram, shall not be liable for any damages or losses arising from the use of this bot, including but not limited to direct, indirect, incidental, punitive, and consequential damages, including loss of profits, data, or business interruption.
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @empire_devil9 on Telegram and @empire_devil9, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @empire_devil9 on Telegram and lokesh_yt9 on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
...
* **📝 ENTIRE AGREEMENT**: This disclaimer constitutes the entire agreement between you and @empire_devil9 on Telegram and lokesh_yt9 on Instagram regarding your use of this bot, and supersedes all prior or contemporaneous agreements or understandings.
